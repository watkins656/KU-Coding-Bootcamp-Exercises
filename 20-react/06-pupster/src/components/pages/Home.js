...
function Home() {
  return (
    <div>
      <div className="welcome-header" style={{backgroundImage: `url(https://i2.wp.com/www.smyrnavision.com/wp-content/uploads/2018/02/Happy-Dog-e1519142101894.jpeg?fit=1000%2C667&ssl=1)`}}>
